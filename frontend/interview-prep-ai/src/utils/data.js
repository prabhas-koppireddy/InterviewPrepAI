export const CARD_BG = [
  ...
  { id: 2, bgcolor: "linear-gradient(135deg, #fef9e7 0%, #f1fdf4 100%)" },
  { id: 3, bgcolor: "linear-gradient(135deg, #caf7ff 0%, #f3fbff 100%)" },
  ...
  { id: 9, bgcolor: "linear-gradient(135deg, #fecff 0%, #f7f5ff 100%)" },
...
export const APP_FEATURES = [
  ...
  },
  {
    ...
    description:
      "Add personal notes to any question and pin important ones to the top — making your learning more organized way",
  },
  {
    id: "04",
